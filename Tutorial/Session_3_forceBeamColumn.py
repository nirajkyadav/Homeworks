...
Reference: Tcl code developed by Abdelrahamn using forceBeamColumn for Popov et al 1972
...
output_folder = os.path.join("Tutorial", "Session_3_Results", "force_Beam_Column")

...
Assignment:
1) Monotonic loading
   Develop moment-curvature diagram using Load control integrator
================================================================================
"""
...
ops.recorder('Node', '-file', os.path.join(output_folder, "Monotonic_Load_Controlled.out"), '-time', '-node', 2, '-dof', 3, 'disp')
...
ultimate_moment = 3050.0             # From Disp Controlled Analysis
numinc = 1000                        # Number of load controlled increments
dK0 = ultimate_moment/numinc         # Load Increment per step
...
for i in range(numinc):
    """ Step through each load increment and collect M-φ data """

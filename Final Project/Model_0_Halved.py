...
# Nodes on Right (Beam Hinge = 114 mm)
ops.node(10,  203.0, 0.0)                       # Right Rigid Link Node
ops.node(11,  203.0 + 114.0, 0.0)               # Plastic Hinge (Halved)
ops.node(12,  317.0 + (848.0 - 317.0)/2 * 1.0, 0.0)
...
# Nodes on Left (Beam Hinge = 114 mm)
ops.node(30, -203.0, 0.0)                       # Left Rigid Link Node
ops.node(31, -203.0 - 114.0, 0.0)               # Plastic Hinge (Halved)
ops.node(32, -317.0 - (848.0 - 317.0)/2 * 1.0, 0.0)
...
# Nodes on Top (Column Hinge = 101.5 mm)
ops.node(20, 0.0, 228.0)                        # Top joint face
ops.node(21, 0.0, 228.0 + 101.5)                # Plastic Hinge (Halved)
ops.node(22, 0.0, 329.5 + ((1236.0-329.5)/4)*1.0)     
ops.node(23, 0.0, 329.5 + ((1236.0-329.5)/4)*2.0)     
ops.node(24, 0.0, 329.5 + ((1236.0-329.5)/4)*3.0)     
ops.node(25, 0.0, 1236.0)                       # Top tip loading node

# Nodes on Bottom (Column Hinge = 101.5 mm)
ops.node(40, 0.0, -228.0)                       # Bottom joint face
ops.node(41, 0.0, -228.0 - 101.5)               # Plastic Hinge (Halved)
ops.node(42, 0.0, -329.5 - ((1236.0-329.5)/4)*1.0)     
ops.node(43, 0.0, -329.5 - ((1236.0-329.5)/4)*2.0)     
ops.node(44, 0.0, -329.5 - ((1236.0-329.5)/4)*3.0)     
...
output_folder = os.path.join("Final_Project", "Results", "Model_0_Halved")
